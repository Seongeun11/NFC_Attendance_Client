...
class NfcApp:
    def __init__(self, root):
        ...
        self.controller = AttendanceController(SUPABASEAUTH)
        # 💡 비즈니스 및 하드웨어 서비스 인스턴스 격리 생성
        self.auth_service = AuthService(SUPABASEAUTH)
        self.search_service = UserSearchService(SUPABASEAUTH)
        self.card_service = NfcCardService(SUPABASEAUTH)
